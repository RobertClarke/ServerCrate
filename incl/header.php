<?php 
  ...
  if (empty($page["description"])) { $page["description"] = "ServerCrate is a hosting business providing web, vps, game, and dedicated server hosting based in Dallas."; }
  if (empty($page["keywords"])) { $page["keywords"] = "server hosting, server hosting dallas, game hosting, game servers"; } 
?>
