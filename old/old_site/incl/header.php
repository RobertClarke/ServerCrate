    ...
    <div id="nav">
        <div id="navContainer">
            <ul>
                ...
                <li<?php if ($page["page"] == "plans") { ?> class="active"<?php } ?>><a href="./plans.php">VPS Plans</a></li>
                <li<?php if ($page["page"] == "features") { ?> class="active"<?php } ?>><a href="./features.php">Hosting Features</a></li>
